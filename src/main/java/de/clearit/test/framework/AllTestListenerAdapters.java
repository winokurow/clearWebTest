...
import de.clearit.test.framework.listener.HtmlToFileOnFailure;
import de.clearit.test.framework.listener.IELocalCleanUpOnTestFinished;
...
import de.clearit.test.framework.listener.WebDriverCleanUpOnTestFinished;
...
public class AllTestListenerAdapters extends AllTestBasisListenerAdapters
{
   ...
   public AllTestListenerAdapters()
   {
      ...
      testListenerAdapter.add(new HtmlToFileOnFailure());
      testListenerAdapter.add(new WebDriverCleanUpOnTestFinished());
      testListenerAdapter.add(new IELocalCleanUpOnTestFinished());
   }
